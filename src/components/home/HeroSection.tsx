...
export function HeroSection() {
  return (
    <section className="relative min-h-[calc(100svh-var(--site-header-height))] overflow-hidden">
      <div className="hero-section__inner mx-auto flex max-w-[1400px] flex-col px-6 pb-10 md:px-10 md:pb-12 lg:grid lg:grid-cols-2 lg:items-start lg:gap-10 lg:pb-14 xl:gap-16">
        ...
        <div className="relative z-10 mt-8 flex min-h-[280px] flex-1 items-start justify-center sm:mt-10 lg:mt-2 lg:min-h-0 lg:justify-end">
          <HeroProductVisual />
        </div>
      </div>
    </section>
