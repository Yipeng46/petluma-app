...
export function FinalCompanionCard({ card }: FinalCompanionCardProps) {
  ...
  return (
    <article
      ...
      className="passport-export-target relative w-full overflow-hidden rounded-[1.4rem] border border-[#b8944d]/35 bg-[#081526] p-3 text-[#172030] shadow-[0_38px_120px_rgba(8,21,38,0.38)] sm:p-5 lg:p-7"
    >
